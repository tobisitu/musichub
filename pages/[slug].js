...
import {BsPiggyBank, BsFillPencilFill, BsFillTrashFill} from 'react-icons/bs';
...
export default function Details() {
    ...
    return(
        <div className='  rounded-lg max-w-2xl mx-auto  grid justify-self-center  h-screen max-h-[85vh] mb-8'>
            <div className=" text-center justify-center items-center  p-16  flex flex-col place-content-center">
            ...
            <div className=" border-none border-solid border-8 border-sky-50  flex flex-row grid grid-cols-3 align-top ">
                <div className="flex flex-col text-center justify-center items-center gap-1 p-4 self-start">
                    ...
                    <h1 className='text-2xl text-orange-700 text-center '>{separateNumber(routeData.streams)}</h1>
                ...
                <div className="flex flex-col text-center justify-center items-center gap-1 p-4 self-start">
                    ...
                    <h1 className='text-2xl text-orange-700 text-center '>${separateNumber(routeData.rate)} </h1>
                    <p className='mt-0 text-sm text-gray-500 text-center '>
                        per Stream
                    </p>
                </div>
                <div className="flex flex-col text-center justify-center items-center gap-1 p-4 self-start">
                    ...
                    <h1 className='text-2xl text-orange-700 text-center '>${separateNumber((routeData.streams * routeData.rate).toFixed(2))}</h1>
                    <p className='mt-0 text-sm text-gray-500 text-center '>
                        made in total 
                    </p>
                </div>
